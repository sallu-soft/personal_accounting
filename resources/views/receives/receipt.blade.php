<x-app-layout>
    ...
    <div class="card-header bg-secondary text-white text-center py-4">
        <h3 class="mb-0"><i class="fas fa-receipt me-2"></i> Receive Receipt</h3>
    </div>

    <div class="container mt-4" id="printable-section">
            ...
            <div class="card-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-6 ps-4">
                        ...
                        <div class="mb-3">
                            <p class="mb-1"><strong>Date:</strong> {{ \Carbon\Carbon::parse($latestReceive->date)->format('d-m-Y') }}</p>
                            <p class="mb-1">
    ...
    <div class="container mt-4">
        ...
        <div class="card-footer text-center bg-light mt-4">
            ...
            <a href="{{ route('receives.index') }}" class="btn btn-secondary">
